...
/** Maps common names / lang-map output → CodeMirror @uiw language ids */
...
/** Resolve a CodeMirror language id from file extension and/or settings hint */
...
/** Language id to store in settings (matches @uiw langNames) */
